...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/skippy/.local/share/nvim/site/pack/packer/opt/coc.nvim"
  },
  ["dashboard-nvim"] = {
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'coc.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
